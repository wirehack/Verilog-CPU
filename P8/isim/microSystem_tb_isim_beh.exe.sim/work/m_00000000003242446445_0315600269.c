...
#endif
static const char *ng0 = "D:/ISEProject/P8/datapath/Load_ext.v";
...
LAB35:    memcpy(t10, t51, 8);

LAB36:    xsi_vlogtype_zero_extend(t9, 32, t10, 8);
    t151 = (t0 + 1768);
...
LAB86:    memcpy(t10, t51, 8);

LAB87:    xsi_vlogtype_sign_extend(t9, 32, t10, 8);
    t151 = (t0 + 1768);
    xsi_vlogvar_assign_value(t151, t9, 0, 0, 32);
    goto LAB19;
...
LAB135:    if (*((unsigned int *)t11) > 0)
        goto LAB136;

LAB137:    memcpy(t10, t52, 8);

LAB138:    xsi_vlogtype_zero_extend(t9, 32, t10, 16);
    t78 = (t0 + 1768);
...
LAB154:    memcpy(t10, t52, 8);

LAB155:    xsi_vlogtype_sign_extend(t9, 32, t10, 16);
    t78 = (t0 + 1768);
    xsi_vlogvar_assign_value(t78, t9, 0, 0, 32);
    goto LAB19;
...
LAB52:    memcpy(t51, t96, 8);

LAB53:    goto LAB31;

LAB32:    xsi_vlog_unsigned_bit_combine(t10, 8, t37, 8, t51, 8);
    goto LAB36;
...
LAB69:    memcpy(t96, t141, 8);

LAB70:    goto LAB48;

LAB49:    xsi_vlog_unsigned_bit_combine(t51, 8, t82, 8, t96, 8);
    goto LAB53;

LAB51:    memcpy(t51, t82, 8);
    goto LAB53;
...
LAB66:    xsi_vlog_unsigned_bit_combine(t96, 8, t127, 8, t141, 8);
    goto LAB70;

LAB68:    memcpy(t96, t127, 8);
    goto LAB70;
...
LAB101:    if (*((unsigned int *)t52) > 0)
        goto LAB102;

LAB103:    memcpy(t51, t96, 8);

LAB104:    goto LAB82;

LAB83:    xsi_vlog_unsigned_bit_combine(t10, 8, t37, 8, t51, 8);
    goto LAB87;

LAB85:    memcpy(t10, t37, 8);
    goto LAB87;
...
LAB116:    if (*((unsigned int *)t123) > 0)
        goto LAB117;

LAB118:    if (*((unsigned int *)t97) > 0)
        goto LAB119;

LAB120:    memcpy(t96, t141, 8);

LAB121:    goto LAB99;

LAB100:    xsi_vlog_unsigned_bit_combine(t51, 8, t82, 8, t96, 8);
    goto LAB104;

LAB102:    memcpy(t51, t82, 8);
    goto LAB104;
...
LAB117:    xsi_vlog_unsigned_bit_combine(t96, 8, t127, 8, t141, 8);
    goto LAB121;

LAB119:    memcpy(t96, t127, 8);
    goto LAB121;
...
LAB134:    xsi_vlog_unsigned_bit_combine(t10, 16, t51, 16, t52, 16);
    goto LAB138;

LAB136:    memcpy(t10, t51, 8);
    goto LAB138;
...
LAB151:    xsi_vlog_unsigned_bit_combine(t10, 16, t51, 16, t52, 16);
    goto LAB155;

LAB153:    memcpy(t10, t51, 8);
    goto LAB155;
